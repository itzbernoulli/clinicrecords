...
class PersonnelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personnel" do
    assert_difference('Personnel.count') do
      post personnels_url, params: { personnel: { email: @personnel.email, first_name: @personnel.first_name, last_name: @personnel.last_name, phone_number: @personnel.phone_number, title: @personnel.title } }
    end
  ...
  test "should update personnel" do
    patch personnel_url(@personnel), params: { personnel: { email: @personnel.email, first_name: @personnel.first_name, last_name: @personnel.last_name, phone_number: @personnel.phone_number, title: @personnel.title } }
